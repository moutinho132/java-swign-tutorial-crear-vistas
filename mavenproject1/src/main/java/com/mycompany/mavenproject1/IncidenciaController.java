...
public class IncidenciaController implements Serializable {
    ...
    @EJB
    private com.mycompany.mavenproject1.IncidenciaFacade ejbFacade;
    ...
    private IncidenciaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("IncidenciaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("IncidenciaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("IncidenciaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Incidencia> getItems() {
        if (items == null) {
    ...
    public Incidencia getIncidencia(java.lang.Long id) {
    ...
    public List<Incidencia> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }

    @FacesConverter(forClass = Incidencia.class)
    public static class IncidenciaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            IncidenciaController controller = (IncidenciaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "incidenciaController");
